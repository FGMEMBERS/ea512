...
aircraft.livery.init("Aircraft/ea512/Models/Liveries");
var FDM ="";
var tanks=[];
var N1=[0.0,0.0];
var fuel_cutoff=[0,0];
...
setlistener("/sim/signals/fdm-initialized", func {
	...
	setprop("/controls/engines/engine[0]/throttle-rvrs-norunning", 0)
    });
...
#Thrust reverser, from the dhc6 by Syd Adams
...
#direct wheel thruster
    ...
    var wts =getprop("/controls/gear/wheel-thruster");
    if(wow==1){
    if(eng1==0){
    if(eng2==0){
    if(wts==1){
    ...
    setprop("/sim/model/pushback/force-rvs",thrust_rvs);
}
}
}
}
